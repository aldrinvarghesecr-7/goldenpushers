...
// Added Parallax and Cursor Interactions.
// ═══════════════════════════════════════════════════════════════
    ...
    >
      {mounted && (
        <>
          ...
          <motion.div 
            style={{ y: yGlow }}
            className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[60vw] h-[40vh] bg-[#D4AF77]/[0.03] blur-[100px] rounded-full pointer-events-none" 
          />
              ...
              {status !== 'success' ? (
                ...
                >
                  ...
                  <div className="flex flex-col justify-center">
                    ...
                    <div className="mt-16 text-white/40 text-[10px] tracking-[0.3em] font-sans uppercase space-y-3 cursor-default" data-cursor-hover>
                      <p className="hover:text-white transition-colors duration-300">Golden Pushers Productions LLP</p>
                      <p className="hover:text-white transition-colors duration-300">goldenpushers@gmail.com</p>
                      <p className="hover:text-white transition-colors duration-300">+91 73063 51867</p>
                    </div>
                  </div>
                  ...
                  >
                    {/* Name Input */}
                    <div className="group relative" data-cursor-hover data-cursor-text="TYPE">
                      <input
                        required
                        type="text"
                        placeholder="Name"
                        className="w-full bg-transparent border-b border-white/10 pb-4 text-white font-sans focus:outline-none focus:border-[#D4AF77] transition-colors peer placeholder-transparent cursor-none"
                        value={formData.name}
                    ...
                    {/* Project Type Select */}
                    <div className="group relative" data-cursor-hover data-cursor-text="SELECT">
                      <select
                        required
                        className="w-full bg-transparent border-b border-white/10 pb-4 text-white/40 font-sans focus:outline-none focus:border-[#D4AF77] transition-colors appearance-none cursor-none"
                        value={formData.type}
                    ...
                    <div className="group relative" data-cursor-hover data-cursor-text="TYPE">
                      <textarea
                        ...
                        rows={4}
                        placeholder="Message"
                        className="w-full bg-transparent border-b border-white/10 pb-4 text-white font-sans focus:outline-none focus:border-[#D4AF77] transition-colors peer placeholder-transparent resize-none cursor-none"
                    ...
                    <button
                      ...
                      className="mt-4 py-4 w-full border border-[#D4AF77]/30 text-[#D4AF77] font-sans font-black tracking-[0.3em] uppercase text-xs hover:bg-[#D4AF77] hover:text-black transition-all duration-700 overflow-hidden relative group disabled:opacity-50 disabled:cursor-none cursor-none"
                    >
                ...
                >
                  ...
                  <motion.button
                    ...
                    data-cursor-hover
                    className="mt-12 text-[10px] font-sans font-bold tracking-[0.4em] text-[#D4AF77] uppercase border-b border-[#D4AF77]/30 pb-1 hover:text-white hover:border-white transition-all duration-500 cursor-none"
                  >
                    Send Another
                  </motion.button>
                </motion.div>
